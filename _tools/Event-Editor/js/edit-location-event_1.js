...
var start = function(){
    var DC = {
        ...
        finishEditPageName:function(){
            ...
            $(spObj).append('<div class="action-button menu-button btn btn-default selected">'+name+'</div>');
        ...
        selectAction:function(num){
            ...
            $(this.p.actionsCont).children(".action:eq("+num+")").children(".action-button").addClass("selected");
        ...
        removeAction:function(){
            $(".action-button.selected").parent().remove();
        },
