...
_tools - Any tools that non-coders can use to create data files.
audio  - Music Files. Split into BGM and SFX.
css    - Cascading Style Sheets. This will probably be used very little.
data   - Assets such as .tmx (Tiled map files) and JSON data/story files. .tmx files must be in the data/ directory as this is where Quintus expects them to be.
